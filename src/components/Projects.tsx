...
const projects = [
	{
		title: "ArtFolio",
		description:
			"A cozy little corner of the internet where I share my love for traditional art and thoughtful design.",
		category: "Design",
	...
	},
	{
		...
		description:
			"Blockchain-based platform to decentralize and democratize scientific research.",
		category: "Blockchain",
		tags: ["React", "TypeScript", "Vite"],
		image: "/images/decentralised.jpg",
		github: "https://github.com/Pranitee-Sonavane/Decentralized-Science",
		demo: "/videos/Decentralised Science.mp4", // Corrected path
	},
	{
		title: "Youtube Video Transcript Summarizer",
		description:
			"YSummarize is a Chrome extension that quickly summarizes YouTube videos, saving users time.",
		category: "Web",
	...
	},
	{
		...
		description:
			"Dashboard displaying real-time sensor data on energy savings, power generation, and voltage.",
		category: "Web",
		tags: ["React", "Arduino", "Socket.IO"],
		image: "/images/ecofriendly.jpg",
		github: "https://github.com/Pranitee-Sonavane/Ecfriendly-Hybrid-Final-Dashboard",
		demo: "/videos/ecofriendly hybrid.mp4",
	},
	{
		title: "Travel and Tourism Management System",
		description:
			"The System is a Java-based project designed to streamline the process of managing travel bookings, itineraries, and customer details",
		category: "Software",
	...
	},
	{
		...
		description:
			"An integrated system to manage hotel operations and NGO activities efficiently.",
		category: "Web",
		tags: ["React", "Firebase", "Material-UI"],
		image: "/images/hopeonaplate.jpg",
					...
					<div className="flex flex-wrap gap-3 justify-center">
						{categories.map((category) => (
							<Button
								...
								className={
									selectedCategory === category ? "glow" : "glass"
								}
							>
								{category}
							</Button>
